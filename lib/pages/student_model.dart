...
const String st_tableContactColinstitute = 'institute';
...
class StudentModel {
  ...
  // @override
  // String toString() {
  //   return 'StudentModel{st_id: $st_id, st_name: $st_name, phone: $phone, address: $address, institute: $institute, dob: $dob, gender: $gender, image: $image, isFav: $isFav}';
  // }
  ...
  Map<String, dynamic> toMap() {
    var map = <String, dynamic>{
      ...
      st_tableContactColinstitute: institute,
  ...
  factory StudentModel.fromMap(Map<String, dynamic> map) => StudentModel(
        ...
        institute: map[st_tableContactColinstitute],
